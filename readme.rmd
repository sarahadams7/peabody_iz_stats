...
Now I want to add in the ecoregion data, here is code template i will use for this https://github.com/jebyrnes/meowR ..... so far have not figured out how to to do this: "using a sp function over, getRegions to provide a wrapper to add MEOW information to the dataset."
